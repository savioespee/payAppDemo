...
export default function EntryScreen3() {
  return (
    <View style={{ flex: 1 }}>
      ...
      <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: 'white'}}>
        <View style={{ position: 'relative' }}>
          ...
          {/* <Hotspot style={{ position: 'absolute', width: '100%', height: '20%', top: '75%' }} toScreenName="Entry4"/> */}
          <Hotspot style={{ position: 'absolute', width: '30%', height: '10%', right: '80%' }} toScreenName="Entry2"/>
        </View>
      </SafeAreaView>
      </ScrollView>
      <SafeAreaView style={{ backgroundColor: 'white' }} edges={['bottom']}>
        <AssetBlockImage source={require('../../../assets/BottomNav3.png')} />
        <Hotspot style={{ position: 'absolute', width: '100%', height: '50%', top: '0%', left: 0 }} toScreenName="Entry4"  />
