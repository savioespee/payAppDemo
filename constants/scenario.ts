  ...
  channels: [
    {
      ...
      states: {
        ...
        AlexReplies1: {
          suggestedReplies: [['Confirm', 'AlexReplies2'], 'Cancel'],
        },
        AlexReplies2: {
          messages: [
          ], after: { delay: 1000, targetState: 'botChecksIssue' },
        },
        botChecksIssue: {
          messages: [
            {
        ...
        agentConfirmed: {
          ...
          ], after: { delay: 3000, targetState: 'AlexReplies5' },
        },
        AlexReplies5: {
          messages: [
            {
          ...
          after: { delay: 2000, targetState: 'botReplies1' },
        },
        botReplies1: {
          messages: [
            {
